...
`Microsoft.MicrosoftEdge*`, `Microsoft.Windows.Photos`, `Microsoft.OneDriveSync`, `Microsoft.WindowsNotepad`, `Microsoft.WindowsTerminal`, `Microsoft.DesktopAppInstaller`, `Microsoft.VCLibs.*`, `Microsoft.UI.Xaml.*`, `Microsoft.NET.Native.*`
...
| 17 | 42 tâches planifiées désactivées (`schtasks /Change /Disable`) |
